    ...
    if (!user) {
      return message.channel.send({
        embeds: [
          new EmbedBuilder()
            .setColor('Red')
            .setDescription(`Non ho trovato ${target.id === message.author.id ? "il tuo username di Last.fm" : "lo username di Last.fm dell'utente specificato"}, importalo usando /import.`)
        ]
      });
    }
